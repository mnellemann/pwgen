...
public class AppViewManager {
    ...
    public static final AppView PRIMARY_VIEW = view("Passwords", PrimaryPresenter.class, MaterialDesignIcon.HOME, SHOW_IN_DRAWER, HOME_VIEW, SKIP_VIEW_STACK);
    public static final AppView SECONDARY_VIEW = view("About", SecondaryPresenter.class, MaterialDesignIcon.DASHBOARD, SHOW_IN_DRAWER);
    ...
    public static void registerViewsAndDrawer(MobileApplication app) {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("Password Generator",
                "Secure & Random Passwords",
                new Avatar(21, new Image(PasswordApplication.class.getResourceAsStream("/icon.png"))));
